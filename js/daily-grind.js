...
function coffeeTemplate(coffee) {
  return `<p>
            ...
            <strong class="feature">${coffee.pic}'s Coffee Special:</strong> ${coffee.pic}'s daily coffee special is <strong class="feature">Pumpkin Spice Latte</strong>, which makes us wish it was always Fall, as this is one of our top sellers!</p>
            `;
}
